...
Revision ID: ce2f26bb335b
Revises: 3743dd4c539b
Create Date: 2021-10-25 11:39:41.787128
...
revision = 'ce2f26bb335b'
down_revision = '3743dd4c539b'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('start_of_reservation', sa.Date(), nullable=True),
    sa.Column('end_of_reservation', sa.Date(), nullable=True),
